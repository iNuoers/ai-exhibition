import type { AnyObject, CacheKey, CacheValue, CombinedCache, ICacheConfig, ICacheMethods } from './types';
 ...
 * @template L - 本地存储缓存类型
 */
class CacheManager<R extends AnyObject, L extends AnyObject> implements ICacheMethods<R, L> {
     ...
     * @param config - 缓存配置
     */
    constructor(config: ICacheConfig<R, L>) {
