...
function SidebarContent({ className, onScroll, style, ...props }: React.ComponentProps<"div">) {
  ...
  const checkScroll = React.useCallback(() => {
    ...
    setShowBottomMask(Math.ceil(scrollTop + clientHeight) < scrollHeight - 1)
  }, [])

  // Check scroll on mount, window resize, and children mutations (e.g. accordion expanding)
  React.useEffect(() => {
    checkScroll()
  ...
  return (
    <div
      ...
      style={{
        maskImage: `linear-gradient(to bottom, ${showTopMask ? "transparent" : "black"}, black 16px, black calc(100% - 16px), ${showBottomMask ? "transparent" : "black"})`,
        WebkitMaskImage: `linear-gradient(to bottom, ${showTopMask ? "transparent" : "black"}, black 16px, black calc(100% - 16px), ${showBottomMask ? "transparent" : "black"})`,
        ...style
      }}
      {...props}
    />
