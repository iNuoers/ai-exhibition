            ...
            <CardContent className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2">
                    <div className="flex items-center gap-3 border-border/50 border-r border-b pt-1 pr-5 pb-4">
                        <span
                            aria-hidden="true"
                            className="flag:US shrink-0 rounded-xs text-lg ring-1 ring-foreground/10"
                        />
                    ...
                    <div className="flex items-center gap-3 border-border/50 border-b pt-1 pb-4 pl-5">
                        <span
                            aria-hidden="true"
                            className="flag:GB shrink-0 rounded-xs text-lg ring-1 ring-foreground/10"
                        />
                    ...
                    <div className="flex items-center gap-3 border-border/50 border-r pt-4 pr-5 pb-1">
                        <span
                            aria-hidden="true"
                            className="flag:CA shrink-0 rounded-xs text-lg ring-1 ring-foreground/10"
                        />
                    ...
                    <div className="flex items-center gap-3 pt-4 pb-1 pl-5">
                        <span
                            aria-hidden="true"
                            className="flag:IN shrink-0 rounded-xs text-lg ring-1 ring-foreground/10"
                        />
