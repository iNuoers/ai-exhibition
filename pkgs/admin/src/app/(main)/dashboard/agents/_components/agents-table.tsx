                ...
                <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
                    ...
                    <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[700px]">
                        <DialogHeader>
                            ...
                            <DialogDescription>Set up a new AI assistant for an exhibition.</DialogDescription>
                        </DialogHeader>
                        <AgentForm onSubmit={handleAddSubmit} onCancel={() => setIsAddDialogOpen(false)} />
                    </DialogContent>
                </Dialog>
            </div>
                ...
                <Table>
                    ...
                    <TableBody>
                        {table.getRowModel().rows?.length ? (
                            ...
                            <TableRow>
                                <TableCell colSpan={agentsColumns.length} className="h-24 text-center">
                                    No results.
                                </TableCell>
                            </TableRow>
                        )}
